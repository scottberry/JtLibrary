            ...
            if plot
                if plot_perimeter_analysis
                    if ~isempty(cellPerimeterProps)
                        ...
                        plots = {
                            jtlib.plotting.create_intensity_image_plot(imCurvature, 'ul'), ...
                            jtlib.plotting.create_intensity_image_plot(imConvexConcave, 'ur'), ...
                            jtlib.plotting.create_intensity_image_plot(imAngle, 'll') ...
                            %jtlib.plotting.create_intensity_image_plot(imRadius, 'lr') ...
                        };
                        figure = jtlib.plotting.create_figure(plots,'title','curvature, concave/convex, angle, radius');
                    end
